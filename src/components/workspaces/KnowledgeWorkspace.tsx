...
export function KnowledgeWorkspace() {
  ...
  return (
    <div className="mx-auto w-full max-w-6xl p-3 sm:p-5">
      <div className="mb-8"><p className="text-[0.65rem] font-semibold uppercase tracking-[0.2em] text-structural">참고 자료실</p><h2 className="mt-1 text-xl font-semibold tracking-tight">지식 자료</h2><p className="mt-2 max-w-2xl text-sm leading-relaxed text-ink-2">시뮬레이션 객체와 설명을 오가며 추상 반응망을 단계적으로 살펴봅니다.</p></div>
